...
for (const element of simpsons) {
    ...
    divElement.innerText = `${element.name} ${element.surname} ${element.age} ${element.info} ${element.photo}`;
...
for (const person of simpsons) {
    ...
    mainDivElement.classList.add('member');

    let nameDivElement = document.createElement('div');
    nameDivElement.innerText = person.name;
    ...
    mainDivElement.append(nameDivElement,surname,age,info,img);
}
...
for (const course of coursesArray) {
    ...
    for (const item of course.modules) {
        ...
        module.appendChild(listItem);
    }

    document.body.appendChild(divHeadElement);
    divHeadElement.append(titleElem, duration, module, list);
